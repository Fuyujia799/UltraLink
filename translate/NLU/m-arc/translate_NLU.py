...
parser.add_argument('--input_file', type=str, default='/home/fuyujia/UltraEval/datasets/m-arc/test.jsonl',)
parser.add_argument('--output_file', type=str, default='/home/fuyujia/UltraEval/datasets/m-arc/test_sample.jsonl',)
